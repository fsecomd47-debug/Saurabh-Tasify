...
const CATALOG_ITEMS: VaultItem[] = [
  // ──────────────────── PETS (30) ────────────────────
  { id: "pet-wolf", name: "Wolf", description: "Loyal companion with keen instincts.", type: "pet", rarity: "common", price: 800, previewAsset: "/assets/pets/wolf.png", status: "active", featured: false, metadata: {}, abilities: [{ type: "pet_xp", value: 0.02, stackingGroup: "pet_xp", maxGroupBonus: 0.10, description: "+2% Pet XP" }], createdAt: new Date(), updatedAt: new Date() },
  { id: "pet-cat", name: "Shadow Cat", description: "Graceful and independent.", type: "pet", rarity: "common", price: 600, previewAsset: "/assets/pets/cat.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "pet-hawk", name: "Hawk", description: "Sharp-eyed aerial scout.", type: "pet", rarity: "uncommon", price: 1200, previewAsset: "/assets/pets/hawk.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "pet-fox", name: "Arctic Fox", description: "Clever and swift.", type: "pet", rarity: "uncommon", price: 1500, previewAsset: "/assets/pets/fox.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "pet-owl", name: "Night Owl", description: "Wise beyond its years.", type: "pet", rarity: "uncommon", price: 1400, previewAsset: "/assets/pets/owl.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "pet-rabbit", name: "Shadow Rabbit", description: "Quick and elusive.", type: "pet", rarity: "common", price: 500, previewAsset: "/assets/pets/rabbit.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "pet-snake", name: "Viper", description: "Silent and deadly.", type: "pet", rarity: "rare", price: 2500, previewAsset: "/assets/pets/snake.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "pet-bear", name: "Grizzly", description: "Powerful protector.", type: "pet", rarity: "rare", price: 3000, previewAsset: "/assets/pets/bear.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "pet-eagle", name: "Golden Eagle", description: "Majestic predator of the skies.", type: "pet", rarity: "rare", price: 3500, previewAsset: "/assets/pets/eagle.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "pet-panther", name: "Shadow Panther", description: "Silent hunter of the night.", type: "pet", rarity: "epic", price: 5000, previewAsset: "/assets/pets/panther.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "pet-dragon", name: "Baby Dragon", description: "Small but fierce.", type: "pet", rarity: "epic", price: 6000, previewAsset: "/assets/pets/dragon.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "pet-phoenix", name: "Phoenix", description: "Rises from the ashes.", type: "pet", rarity: "legendary", price: 10000, previewAsset: "/assets/pets/phoenix.png", status: "active", featured: true, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "pet-unicorn", name: "Celestial Unicorn", description: "Magical being of pure light.", type: "pet", rarity: "legendary", price: 12000, previewAsset: "/assets/pets/unicorn.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "pet-griffin", name: "Griffin", description: "Majestic hybrid of eagle and lion.", type: "pet", rarity: "legendary", price: 15000, previewAsset: "/assets/pets/griffin.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "pet-kraken", name: "Baby Kraken", description: "Terror of the deep.", type: "pet", rarity: "mythic", price: 25000, previewAsset: "/assets/pets/kraken.png", status: "active", featured: true, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "pet-leviathan", name: "Leviathan", description: "Ancient sea monster.", type: "pet", rarity: "mythic", price: 30000, previewAsset: "/assets/pets/leviathan.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "pet-manticore", name: "Manticore", description: "Lion body, scorpion tail.", type: "pet", rarity: "epic", price: 7000, previewAsset: "/assets/pets/manticore.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "pet-chimera", name: "Chimera", description: "Fire-breathing hybrid.", type: "pet", rarity: "epic", price: 8000, previewAsset: "/assets/pets/chimera.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "pet-penguin", name: "Penguin", description: "Adorable waddler.", type: "pet", rarity: "common", price: 400, previewAsset: "/assets/pets/penguin.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "pet-panda", name: "Panda", description: "Gentle giant.", type: "pet", rarity: "uncommon", price: 1800, previewAsset: "/assets/pets/panda.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "pet-tiger", name: "Bengal Tiger", description: "Striped royalty.", type: "pet", rarity: "rare", price: 4000, previewAsset: "/assets/pets/tiger.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "pet-lion", name: "African Lion", description: "King of beasts.", type: "pet", rarity: "legendary", price: 11000, previewAsset: "/assets/pets/lion.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "pet-robot-dog", name: "Robo Dog", description: "Cybernetic companion.", type: "pet", rarity: "rare", price: 2800, previewAsset: "/assets/pets/robot-dog.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "pet-ghost", name: "Ghost", description: "Ethereal protector.", type: "pet", rarity: "epic", price: 5500, previewAsset: "/assets/pets/ghost.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "pet-fairy", name: "Fairy", description: "Sparkle dust trail.", type: "pet", rarity: "uncommon", price: 1600, previewAsset: "/assets/pets/fairy.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "pet-golem", name: "Stone Golem", description: "Unbreakable guardian.", type: "pet", rarity: "rare", price: 3200, previewAsset: "/assets/pets/golem.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "pet-wisp", name: "Will-o-Wisp", description: "Mysterious guiding light.", type: "pet", rarity: "uncommon", price: 1300, previewAsset: "/assets/pets/wisp.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "pet-cerberus", name: "Cerberus", description: "Three-headed guardian.", type: "pet", rarity: "mythic", price: 28000, previewAsset: "/assets/pets/cerberus.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "pet-sphinx", name: "Sphinx", description: "Guardian of secrets.", type: "pet", rarity: "legendary", price: 14000, previewAsset: "/assets/pets/sphinx.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "pet-turtle", name: "Ancient Turtle", description: "Wise and enduring.", type: "pet", rarity: "uncommon", price: 1100, previewAsset: "/assets/pets/turtle.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },

  // ──────────────────── CARS (35) ────────────────────
  { id: "car-pulse", name: "Pulse X", description: "Electric street racer.", type: "car", rarity: "common", price: 2000, previewAsset: "/assets/cars/pulse-x.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "car-drift", name: "Drift S", description: "Precision cornering.", type: "car", rarity: "common", price: 2500, previewAsset: "/assets/cars/drift-s.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "car-volt", name: "Volt R", description: "Pure electric power.", type: "car", rarity: "uncommon", price: 4000, previewAsset: "/assets/cars/volt-r.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "car-apex", name: "Apex", description: "Track-focused weapon.", type: "car", rarity: "uncommon", price: 4500, previewAsset: "/assets/cars/apex.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "car-shadow", name: "Shadow RS", description: "Silent assassin.", type: "car", rarity: "rare", price: 7000, previewAsset: "/assets/cars/shadow-rs.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "car-blaze", name: "Blaze GT", description: "Fire on four wheels.", type: "car", rarity: "rare", price: 8000, previewAsset: "/assets/cars/blaze-gt.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "car-thunder", name: "Thunderbolt", description: "Lightning fast.", type: "car", rarity: "epic", price: 12000, previewAsset: "/assets/cars/thunderbolt.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "car-aurora", name: "Aurora GT", description: "Northern lights on asphalt.", type: "car", rarity: "epic", price: 14000, previewAsset: "/assets/cars/aurora-gt.png", status: "active", featured: true, metadata: {}, abilities: [{ type: "mission_xp", value: 0.05, stackingGroup: "vehicle_xp", maxGroupBonus: 0.10, description: "+5% Mission XP" }], createdAt: new Date(), updatedAt: new Date() },
  { id: "car-vortex", name: "Vortex GT", description: "Tornado in a bottle.", type: "car", rarity: "rare", price: 7500, previewAsset: "/assets/cars/vortex-gt.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "car-titan", name: "Titan R", description: "Unstoppable force.", type: "car", rarity: "epic", price: 15000, previewAsset: "/assets/cars/titan-r.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "car-phantom", name: "Phantom X", description: "Ghost on the highway.", type: "car", rarity: "legendary", price: 22000, previewAsset: "/assets/cars/phantom-x.png", status: "active", featured: true, metadata: {}, abilities: [{ type: "mission_xp", value: 0.08, stackingGroup: "vehicle_xp", maxGroupBonus: 0.10, description: "+8% Mission XP" }], createdAt: new Date(), updatedAt: new Date() },
  { id: "car-nebula", name: "Nebula R1", description: "Cosmic speed machine.", type: "car", rarity: "legendary", price: 25000, previewAsset: "/assets/cars/nebula-r1.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "car-infinity", name: "Infinity", description: "Beyond limits.", type: "car", rarity: "mythic", price: 40000, previewAsset: "/assets/cars/infinity.png", status: "active", featured: true, metadata: {}, abilities: [{ type: "mission_xp", value: 0.10, stackingGroup: "vehicle_xp", maxGroupBonus: 0.10, description: "+10% Mission XP" }], createdAt: new Date(), updatedAt: new Date() },
  { id: "car-zero", name: "Zero GS", description: "Zero to sixty in nothing.", type: "car", rarity: "common", price: 1500, previewAsset: "/assets/cars/zero-gs.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "car-flux", name: "Flux", description: "Time-bending acceleration.", type: "car", rarity: "uncommon", price: 3800, previewAsset: "/assets/cars/flux.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "car-nova", name: "Nova", description: "Stellar performance.", type: "car", rarity: "rare", price: 6500, previewAsset: "/assets/cars/nova.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "car-quake", name: "Quake", description: "Earth-shaking power.", type: "car", rarity: "uncommon", price: 4200, previewAsset: "/assets/cars/quake.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "car-blitz", name: "Blitz", description: "Lightning strike.", type: "car", rarity: "rare", price: 7200, previewAsset: "/assets/cars/blitz.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "car-storm", name: "Storm Chaser", description: "Rides the lightning.", type: "car", rarity: "epic", price: 13000, previewAsset: "/assets/cars/storm-chaser.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "car-crimson", name: "Crimson Fury", description: "Blood red fury.", type: "car", rarity: "legendary", price: 20000, previewAsset: "/assets/cars/crimson-fury.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "car-onyx", name: "Onyx", description: "Dark as midnight.", type: "car", rarity: "common", price: 1800, previewAsset: "/assets/cars/onyx.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "car-frost", name: "Frost Bite", description: "Cold as ice.", type: "car", rarity: "uncommon", price: 3500, previewAsset: "/assets/cars/frost-bite.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "car-solar", name: "Solar Flare", description: "Blinding speed.", type: "car", rarity: "rare", price: 8500, previewAsset: "/assets/cars/solar-flare.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "car-quantum", name: "Quantum", description: "Exists everywhere at once.", type: "car", rarity: "mythic", price: 45000, previewAsset: "/assets/cars/quantum.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "car-pulse-ev", name: "Pulse EV", description: "Electric evolution.", type: "car", rarity: "common", price: 2200, previewAsset: "/assets/cars/pulse-ev.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "car-raptor", name: "Raptor", description: "Apex predator.", type: "car", rarity: "uncommon", price: 4800, previewAsset: "/assets/cars/raptor.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "car-sentinel", name: "Sentinel", description: "Guardian of the road.", type: "car", rarity: "rare", price: 6800, previewAsset: "/assets/cars/sentinel.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "car-wraith", name: "Wraith", description: "Silent death.", type: "car", rarity: "epic", price: 16000, previewAsset: "/assets/cars/wraith.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "car-apollo", name: "Apollo", description: "Sun god's chariot.", type: "car", rarity: "legendary", price: 28000, previewAsset: "/assets/cars/apollo.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "car-hellcat", name: "Hellcat", description: "Pure American muscle.", type: "car", rarity: "rare", price: 9000, previewAsset: "/assets/cars/hellcat.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "car-demon", name: "Demon", description: "Forged in hellfire.", type: "car", rarity: "legendary", price: 24000, previewAsset: "/assets/cars/demon.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "car-ghost-rider", name: "Ghost Rider", description: "Flaming wheels.", type: "car", rarity: "mythic", price: 50000, previewAsset: "/assets/cars/ghost-rider.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "car-spark", name: "Spark", description: "Small but electric.", type: "car", rarity: "common", price: 1200, previewAsset: "/assets/cars/spark.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "car-rush", name: "Rush", description: "Adrenaline on wheels.", type: "car", rarity: "uncommon", price: 3200, previewAsset: "/assets/cars/rush.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },

  // ──────────────────── SUPERBIKES (25) ────────────────────
  { id: "bike-pulse", name: "Pulse 600", description: "Entry-level sport bike.", type: "superbike", rarity: "common", price: 1800, previewAsset: "/assets/bikes/pulse-600.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "bike-blade", name: "Blade S", description: "Sharp handling.", type: "superbike", rarity: "common", price: 2000, previewAsset: "/assets/bikes/blade-s.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "bike-venom", name: "Venom", description: "Deadly acceleration.", type: "superbike", rarity: "uncommon", price: 3500, previewAsset: "/assets/bikes/venom.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "bike-fury", name: "Fury X", description: "Raw power.", type: "superbike", rarity: "uncommon", price: 4000, previewAsset: "/assets/bikes/fury-x.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "bike-spectre", name: "Spectre", description: "Ghostly speed.", type: "superbike", rarity: "rare", price: 6000, previewAsset: "/assets/bikes/spectre.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "bike-raptor", name: "Raptor 1000", description: "Apex predator.", type: "superbike", rarity: "rare", price: 7000, previewAsset: "/assets/bikes/raptor-1000.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "bike-vortex", name: "Vortex S", description: "Tornado twist.", type: "superbike", rarity: "rare", price: 7500, previewAsset: "/assets/bikes/vortex-s.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "bike-thunder", name: "Thunder 1200", description: "Lightning strike.", type: "superbike", rarity: "epic", price: 11000, previewAsset: "/assets/bikes/thunder-1200.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "bike-nebula", name: "Nebula R1", description: "Cosmic superbike.", type: "superbike", rarity: "epic", price: 14000, previewAsset: "/assets/bikes/nebula-r1.png", status: "active", featured: true, metadata: {}, abilities: [{ type: "mission_xp", value: 0.06, stackingGroup: "vehicle_xp", maxGroupBonus: 0.10, description: "+6% Mission XP" }], createdAt: new Date(), updatedAt: new Date() },
  { id: "bike-phantom", name: "Phantom S", description: "Silent assassin.", type: "superbike", rarity: "epic", price: 15000, previewAsset: "/assets/bikes/phantom-s.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "bike-infinity", name: "Infinity Blade", description: "Beyond limits.", type: "superbike", rarity: "legendary", price: 22000, previewAsset: "/assets/bikes/infinity-blade.png", status: "active", featured: true, metadata: {}, abilities: [{ type: "mission_xp", value: 0.08, stackingGroup: "vehicle_xp", maxGroupBonus: 0.10, description: "+8% Mission XP" }], createdAt: new Date(), updatedAt: new Date() },
  { id: "bike-quantum", name: "Quantum Rush", description: "Time-bending speed.", type: "superbike", rarity: "mythic", price: 35000, previewAsset: "/assets/bikes/quantum-rush.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "bike-flux", name: "Flux 600", description: "Electric street fighter.", type: "superbike", rarity: "common", price: 1500, previewAsset: "/assets/bikes/flux-600.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "bike-shadow", name: "Shadow 750", description: "Darkness rides.", type: "superbike", rarity: "uncommon", price: 3800, previewAsset: "/assets/bikes/shadow-750.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "bike-blitz", name: "Blitz", description: "Lightning fast.", type: "superbike", rarity: "rare", price: 6500, previewAsset: "/assets/bikes/blitz.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "bike-crimson", name: "Crimson Blaze", description: "Fire on two wheels.", type: "superbike", rarity: "epic", price: 13000, previewAsset: "/assets/bikes/crimson-blaze.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "bike-aurora", name: "Aurora", description: "Northern lights.", type: "superbike", rarity: "legendary", price: 20000, previewAsset: "/assets/bikes/aurora.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "bike-demon", name: "Demon 1000", description: "Hell's machine.", type: "superbike", rarity: "legendary", price: 25000, previewAsset: "/assets/bikes/demon-1000.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "bike-storm", name: "Storm", description: "Rides the lightning.", type: "superbike", rarity: "uncommon", price: 3200, previewAsset: "/assets/bikes/storm.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "bike-rush", name: "Rush 500", description: "Adrenaline pump.", type: "superbike", rarity: "common", price: 1600, previewAsset: "/assets/bikes/rush-500.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "bike-apex", name: "Apex 1000", description: "Track weapon.", type: "superbike", rarity: "rare", price: 8000, previewAsset: "/assets/bikes/apex-1000.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "bike-viper", name: "Viper", description: "Strikes fast.", type: "superbike", rarity: "uncommon", price: 3000, previewAsset: "/assets/bikes/viper.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "bike-ghost", name: "Ghost Rider", description: "Undead speed.", type: "superbike", rarity: "mythic", price: 40000, previewAsset: "/assets/bikes/ghost-rider.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "bike-titan", name: "Titan", description: "Heavyweight champion.", type: "superbike", rarity: "epic", price: 12000, previewAsset: "/assets/bikes/titan.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
  { id: "bike-nova", name: "Nova", description: "Stellar performance.", type: "superbike", rarity: "common", price: 1400, previewAsset: "/assets/bikes/nova.png", status: "active", featured: false, metadata: {}, createdAt: new Date(), updatedAt: new Date() },
